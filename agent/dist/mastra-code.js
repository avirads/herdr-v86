...
// shims/globals.js
var import_browser, import_buffer, setImmediatePolyfill, clearImmediatePolyfill;
var init_globals = __esm({
  "shims/globals.js"() {
    ...
    setImmediatePolyfill = globalThis.setImmediate ?? ((fn, ...args) => setTimeout(() => fn(...args), 0));
    clearImmediatePolyfill = globalThis.clearImmediate ?? ((id) => clearTimeout(id));
  }
});

// src/mastra-code.js
init_globals();
var MASTRA_AGENT_URLS = [
  new URL("./mastra-agent.js", import.meta.url).href
];
var THREAD_DB_NAME = "vmmastra-code";
var THREAD_STORE = "threads";
var THREAD_DB_VERSION = 1;
var MODES = ["code", "chat", "batch"];
var SLASH_COMMANDS = {
...
var CodeAgentHarness = class {
  ...
  async saveThread() {
    ...
    this.currentThread.updatedAt = /* @__PURE__ */ new Date();
...
async function createCodeAgentHarness(options) {
