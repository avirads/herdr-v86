...
export const DEFAULT_INSTRUCTIONS = [
  ...
  'Installed commands include BusyBox utilities, jq, rg, git, curl, tar, gzip, qjs, vmjs, shfmt, ctags, make, patch, k6, and vmproject. ShellCheck is not installed in this fixed-size i686 image.',
  'Use Grafana k6 for JavaScript HTTP/API performance and load tests. Remote curl, git, and k6 targets need a default IP route; without one use vmfetch for CORS-enabled HTTPS or vmgithub archive for GitHub sources.',
