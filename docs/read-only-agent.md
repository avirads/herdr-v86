...
shell execution, project memory, project skills, context management, session
checkpoints, and subagent delegation. Every mutation and shell command requires
explicit browser approval enforced by the guest backend.
