...
- Bridge running: `& $env:BH_ADMIN start`.
- Extension connected: verify with `& $env:BH_CLIENT health` and require
...
& $env:BH_CLIENT relatedActions '["Desktop|Account|Policy|Search|Administration|Next|Withdraw",240]'
```
