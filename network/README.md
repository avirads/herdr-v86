...
installer in `network/helper-package/` (`Install AutoBro Helper.cmd`, with a
prebuilt Windows binary at `downloads/autobro-helper-windows-amd64.zip`). The
helper runs
...
```bash
sudo v86net-token 900 https://fapstaff.com
```
